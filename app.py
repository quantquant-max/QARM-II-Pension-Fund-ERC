...
Here is my code for a web app that give the user an ERC portfolio. I want you to upgrade it. I want three tabs, the first one is the asset selection, the second one is the portfolio results with a chart that compares it to the benchmark, the last tab is an "about us" page import streamlit as st
import pandas as pd
import numpy as np
